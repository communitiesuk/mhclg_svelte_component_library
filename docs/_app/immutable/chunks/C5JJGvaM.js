import"./CWj6FrbW.js";import{p as G,D as E,f as R,s as H,a as K,c as w,r as A,G as e,t as Q,I as h,B as $,a9 as F,F as N,u as te}from"./Cp2qfsB-.js";import{t as k,c as ae,a as g}from"./R2PrfaHS.js";import{i as L}from"./B50VFNeR.js";import{s as oe}from"./ClzGr448.js";import{B as re,d as ie}from"./BaIcpsm5.js";import{W as ne,P as se,C as ce,B as le,a as de,t as pe,c as fe}from"./C6OlZ2-B.js";import{p as ve}from"./D0uMktHg.js";import{k as me}from"./lMwbQCpd.js";import{M as X}from"./CYb-G-2i.js";import{d as ue,s as z}from"./Df23Nigv.js";import{e as he,i as ge}from"./FoQIP_hg.js";import{s as be}from"./B2Z6IM-T.js";import{A as ye,a as Se}from"./DJvrVyRN.js";import"./69_IOA4Y.js";import{C as xe}from"./BywTUfDC.js";const Ne=`
<script lang="ts">
...
`;function we(b,p){h(p,!e(p))}var Ae=k('<p class="text-center text-gray-500 italic p-4">MobileNav is closed. Click the button above to open.</p>'),He=k(`<div class="p-5 bg-white border border-neutral-300 relative"><p class="govuk-body mb-4">This example shows how to control the <code>MobileNav</code> component's visibility
    ...
    controlled by a component like <code>HeaderNav</code>.</p> <div class="border border-neutral-300 min-h-[400px] bg-gray-50 demo-mobile-nav-container svelte-lf2kjm"><!></div>`,1),Be=k('<!> <!> <!> <div id="examples" data-role="examples-section"><!></div>',1);function $e(b,p){G(p,!0);const D=t=>{var a=je(),n=H(R(a),2),s=w(n);{var d=x=>{X(x,oe(()=>e(m),{get activeSectionHref(){return e(_)},set activeSectionHref(B){h(_,B,!0)},get activeDetailHref(){return e(C)},set activeDetailHref(B){h(C,B,!0)}}))},P=x=>{var B=Ie();g(x,B)};L(s,x=>{e(m).isOpen?x(d):x(P,!1)})}A(n),g(t,a)};let f=ve.url.pathname.split("/"),T=me(f[f.length-1]),M=E(F(ie.sm)),_=E("#components"),C=E("/components/layout/service-navigation-nested-mobile/mobile-nav"),I=F({counter:0,dataset:{lastHref:null},functionAsString:`function (href, event) {
  window.alert(

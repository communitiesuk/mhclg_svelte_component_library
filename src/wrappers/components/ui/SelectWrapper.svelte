...
<script>
  ...
  import Examples from "./select/Examples.svelte";
  ...
  let parametersSourceArray = $derived(
    addIndexAndInitalValue([
      ...
      },
      {
        ...
        isBinded: true,
        value: selectedValue,
        options: ["govuk-1", "govuk-2", "govuk-4"],
        description: {
          markdown: true,
          arr: [
            `The value of the currently selected option. Use <code>bind:value</code> to enable two-way data binding.`,
      ...
      },
      {
        name: "hint",
        category: "Label and hints",
        value: "This is a hint to help the user.",
        description: {
          markdown: true,
...

      {
        ...
        value: "extra-form-group-class",
        description: {
          markdown: true,
          arr: [
            `Optional additional CSS classes to apply to the wrapping <code>govuk-form-group</code> div.`,
          ],
        },
      },
      {
        ...
        description: {
          markdown: true,
          arr: [
            `If <code>true</code>, applies the <code>govuk-!-width-full</code> class to make the select element take up the full width of its container.`,
          ],
        },
      },
      {
      ...
      },
      {
        ...
        value: "my-select-component",
        isProp: false,
        description: {
          markdown: true,
          arr: [
            `An example of passing additional HTML attributes (like <code>data-testid</code>) which will be spread onto the <code>select</code> element using <code>{...attributes}</code>.`,
          ],
        },
      },
    ]),

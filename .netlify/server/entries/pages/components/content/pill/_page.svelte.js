...
import { a as addIndexAndInitalValue, t as trackVisibleParameters, c as createParametersObject, C as ComponentDetails, P as ParametersSection, S as ScreenSizeRadio, b as Pill, d as defaultScreenWidthBreakpoints } from "../../../../../chunks/trackVisibleParameters.js";
...
function _page($$payload, $$props) {
  ...
  let details = {
    ...
    description: [
      {
        content: "A compact label that provides status or metadata for a primary interface area."
      },
      {
        content: 'Currently relying on the <a href="https://flowbite-svelte.com/docs/components/tooltip">Flowbite tooltip</a> for hover functionality.',
        markdown: true
      }
    ],
    /**
  ...
  function $$render_inner($$payload2) {
    ...
    if (!homepage) {
      ...
      $$payload2.out += `<!----></div> <div data-role="component-container" class="svelte-12gp6g5"><div data-role="component-container-centered"${attr("style", `width: ${stringify(demoScreenWidth)}px;`)} class="svelte-12gp6g5"><div class="flex gap-4 flex-wrap items-center"><h6>A placeholder title of some kind</h6> `;
      Pill($$payload2, spread_props([
        parametersObject,
        { borderRadius: "5px", tooltipText: "false" }
      ]));
      $$payload2.out += `<!----></div></div></div> <div class="mt-20 svelte-12gp6g5" data-role="examples-section">`;

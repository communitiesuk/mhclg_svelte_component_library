<script lang="ts">
    let {
        ...
        homepageUrl = "/",
        oneLoginUrl = "https://home.account.gov.uk",
        logoutUrl = "/logout"
    } = $props<{
    ...
    const navigationId = "one-login-header__nav";
...
<div
        class="rebranded-cross-service-header"
        class:govuk-header--full-width-border={fullWidthBorder}
        data-module="one-login-header"
>
    <div
            class="rebranded-one-login-header"
        ...
        <div class="rebranded-one-login-header__container govuk-width-container">
            <div class="rebranded-one-login-header__logo">
                ...
                >
                    ...
                    <!-- Keep the GOV.UK logo paths from your existing SVG here. -->
                    <g>
                    ...
                    <circle
                            class="rebranded-one-login-header__logo-dot"
                            cx="226"
                            cy="36"
                            r="7.3"
                    ></circle>

                    <!-- Keep your existing GOV.UK lettering path here. -->
                    <path
            ...
            <button
                    ...
                    aria-label={menuOpen
                    ? "Hide GOV.UK One Login menu"
                    : "Show GOV.UK One Login menu"}
                    ...
                    class:rebranded-cross-service-header__toggle--open={menuOpen}
                    onclick={toggleMenu}
            >
                <span class="rebranded-cross-service-header__toggle-content-wrapper">
                    <svg
                            ...
                            fill="currentColor"
                            class="rebranded-cross-service-header__logo"
                            aria-hidden="true"
                    >
                        <path
                        ...
                        ></path>
                        <path
                                d="M221.275 471.046H179.231V365.202H420.769V407.246H221.275V471.046Z"
                        ></path>
                    </svg>

                    <span class="rebranded-cross-service-header__toggle-content">
                        One Login
                    </span>
                </span>
            </button>
            ...
            <nav
                    ...
                    class:rebranded-one-login-header__nav--open={menuOpen}
            ...
            >
                <ul class="rebranded-one-login-header__nav__list">
                    <li class="rebranded-one-login-header__nav__list-item">
                        <a
                                class      <span class="rebranded-one-login-header__nav__text">
                                <svg
                                        focusable="false"
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="15"
                    ...
                    <li class="rebranded-one-login-header__nav__list-item">
                        <a
                                class="rebranded-one-login-header__nav__link"
                                href={logoutUrl}
                                onclick={closeMenu}
                        >
                            Sign out

<script module>
  ...
  let connectedComponentsArray = [
    { label: "Parent component", arr: [{ name: "Axis", folder: "data-vis" }] },
  ];
</script>
...
<script>
  ...
  import TicksFunctionProp from "$lib/components/data-vis/axis/TicksFunctionProp.svelte";
  ...
  let parametersSourceArray = $derived(
    addIndexAndInitalValue([
      ...
      {
        name: "convertToYearFormat",
        category: "tickFormatting",
        value: false,
      },
      {
        name: "useShortYearFormat",
        category: "tickFormatting",
        value: false,
      },
      {
      ...
      {
        name: "formattingFunction",
        category: "tickFormatting",
        value: function (tick, index) {
          return tick;
        },
        functionElements: {
          functionAsString: `function (tick) {
return "£" + tick;
},`,
        },
      },
    ...
    <svg width={demoScreenWidth} height={getValue("svgHeight")}>
      ...
      >
        {#key parametersObject}
          <TicksFunctionProp {...parametersObject} bind:ticksArray
          ></TicksFunctionProp>
        {/key}
      </g>
    </svg>

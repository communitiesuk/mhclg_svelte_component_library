<script module>
  ...
  let descriptionArray = [
    ...
    'Based on the <a href="https://design-system.service.gov.uk/components/inset-text/" target="_blank" rel="noopener noreferrer">GOV.UK Design System inset text component</a>.',
  ];

  let contextArray = [
    "It can be used to highlight information such as legal requirements, warnings, or important context.",
    "The component visually sets apart the content with border and padding.",
  ];
...
<script>
  ...
  import Examples from "./inset-text/Examples.svelte";
...
{#snippet Component()}
  <div class="p-8">
    <InsetText {...parametersObject}></InsetText>
  </div>
{/snippet}

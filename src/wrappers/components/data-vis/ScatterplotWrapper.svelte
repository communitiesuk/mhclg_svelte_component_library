...
import Scatterplot from "$lib/components/data-vis/Scatterplot.svelte";
import Examples from "./scatterplot/Examples.svelte";
...
{#snippet Component()}
  <div class="p-8">
<Scatterplot {...parametersObject}></Scatterplot>
  </div>
{/snippet}

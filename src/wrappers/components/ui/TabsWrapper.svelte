<script module>
  ...
  let descriptionArray = [
    ...
    'Based on the <a href="https://design-system.service.gov.uk/components/tabs/" target="_blank" rel="noopener noreferrer">GOV.UK Design System tabs component</a>.',
  ];

  let contextArray = [
    "Use the Tabs component when you need to let users quickly navigate between related sections of content on the same page.",
    "The component is responsive and will automatically switch to a stacked layout on smaller screens.",
  ];
...
<script>
  ...
  import Examples from "./tabs/Examples.svelte";
    ...
    addIndexAndInitalValue([
      {
        ...
        description: {
          markdown: true,
          arr: [
            "The heading text for the tabs component. This will be displayed above the tabs.",
          ],
        },
      },
      {

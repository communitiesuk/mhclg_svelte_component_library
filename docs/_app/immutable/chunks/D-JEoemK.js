import"./CWj6FrbW.js";import{p as X,D as V,f as E,s as v,c as n,t as W,a as Y,r as o,I as T,G as e,F as B,B as U,a9 as q,u as ie}from"./Cp2qfsB-.js";import{t as u,a as p,c as oe}from"./R2PrfaHS.js";import{p as R,s as re}from"./ClzGr448.js";import{B as ne,d as se}from"./BaIcpsm5.js";import{e as le,W as de,P as ce,C as ve,B as pe,a as ue,t as me,c as ge}from"./C6OlZ2-B.js";import{p as fe}from"./D0uMktHg.js";import{k as be}from"./lMwbQCpd.js";import{d as he,s as J}from"./Df23Nigv.js";import{i as Z}from"./B50VFNeR.js";import{e as K,i as Q}from"./FoQIP_hg.js";import{a as F,s as H}from"./DzqlWAzk.js";import{o as _e}from"./DTclXqla.js";import{s as xe}from"./B2Z6IM-T.js";import{A as Se,a as Ie}from"./DJvrVyRN.js";import"./69_IOA4Y.js";import{C as M}from"./BywTUfDC.js";function we(l,t,a,d,r){l.preventDefault(),T(t,!e(t)),T(a,e(d)&&!e(t)&&!r().disabled,!0)}var ye=u('<button class="dwp-side-navigation__button svelte-112oika" data-module="dwp-side-navigation" data-target="dwp-side-navigation-panel"><span class="dwp-side-navigation__section-toggle-focus"><span></span> <span class="dwp-side-navigation__section-toggle-text svelte-112oika"> </span></span></button>'),Ae=u('<li class="dwp-side-navigation__sub-item svelte-112oika"><a> </a></li>'),ke=u('<ul class="dwp-side-navigation__list dwp-side-navigation__list--sub-item svelte-112oika"></ul>'),Ce=u("<li><a> </a> <!></li>"),Pe=u('<!> <nav><ul class="dwp-side-navigation__list svelte-112oika"></ul></nav>',1);function D(l,t){X(t,!0);let a=R(t,"items",19,()=>[]),d=R(t,"ariaLabel",3,"Side"),r=R(t,"selectedItem",11,""),O=R(t,"selectedSubItem",11,""),g=R(t,"mobile",19,()=>({disabled:!1,showButtonText:"Show navigation",hideButtonText:"Hide navigation"})),_=V(!1),x=V(!1),S=V(!1);_e(()=>{T(x,!0),T(S,e(x)&&!e(_)&&!g().disabled,!0)});var A=Pe(),P=E(A);{var k=s=>{var i=ye();i.__click=[we,_,S,x,g];var I=n(i),C=n(I),w=v(C,2),f=n(w,!0);o(w),o(I),o(i),W(()=>{H(i,"aria-expanded",e(_)),F(C,1,`dwp-side-navigation__chevron ${(e(_)?"dwp-side-navigation__chevron--down":"")??""}`,"svelte-112oika"),J(f,e(_)?g().hideButtonText:g().showButtonText)}),p(s,i)};Z(P,s=>{g().disabled||s(k)})}var m=v(P,2),h=n(m);K(h,21,a,Q,(s,i)=>{var I=Ce();const C=B(()=>e(i).href&&e(i).href===r()),w=B(()=>O()||r());var f=n(I),$=n(f,!0);o(f);var z=v(f,2);{var c=b=>{var N=ke();K(N,21,()=>e(i).subItems,Q,(j,y)=>{var G=Ae(),L=n(G),ae=n(L,!0);o(L),o(G),W(()=>{H(L,"id",e(y).id),H(L,"href",e(y).href),F(L,1,`dwp-side-navigation__link${(e(w)===e(y).href?" dwp-side-navigation__link--selected":"")??""}`,"svelte-112oika"),H(L,"aria-current",e(w)===e(y).href?"true":void 0),J(ae,e(y).text)}),p(j,G)}),o(N),p(b,N)};Z(z,b=>{e(C)&&e(i).subItems&&e(i).subItems.length>0&&b(c)})}o(I),W(()=>{F(I,1,`dwp-side-navigation__item${(e(C)?" dwp-side-navigation__item--selected":"")??""}`,"svelte-112oika"),H(f,"id",e(i).id),H(f,"href",e(i).href),F(f,1,`dwp-side-navigation__link${(e(w)===e(i).href?" dwp-side-navigation__link--selected":"")??""}`,"svelte-112oika"),H(f,"aria-current",e(w)===e(i).href?"true":void 0),J($,e(i).text)}),p(s,I)}),o(h),o(m),W(()=>{F(m,1,`dwp-side-navigation ${(e(S)?"dwp-side-navigation--mobile":"")??""}`,"svelte-112oika"),H(m,"aria-label",d())}),p(l,A),Y()}he(["click"]);const Ne=`
<script>

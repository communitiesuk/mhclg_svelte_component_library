<script module>
  ...
  let contextArray = [
    "Use the masthead component on service homepages to introduce users to your service.",
    "Include a clear, descriptive title that explains what your service does.",
    "Provide a brief description that helps users understand the purpose and benefits of your service.",
    "Include a prominent call-to-action button that guides users to get started.",
    "Consider adding an illustration to make the page more engaging and help users understand your service.",
  ];
...
<script>
  ...
  import Examples from "./masthead/Examples.svelte";
    ...
    addIndexAndInitalValue([
      {
        ...
        description: {
          markdown: true,
          arr: [
            "The main heading text for the masthead. This should clearly describe what your service does.",
            "Keep it concise but descriptive. Users should understand the purpose of your service from this title alone.",
          ],
        },
        rows: 2,
      },
      {
        ...
        description: {
          markdown: true,
          arr: [
            "Supporting text that provides more detail about your service.",
            "Explain the benefits and purpose of your service to help users understand why they should use it.",
          ],
        },
        rows: 4,
      },
      ...
      },
      {
        ...
        description: {
          ...
          arr: [
            ...
            "Use action-oriented language that tells users what will happen when they click the button.",
          ],
        },
      },
      {
        ...
        description: {
          ...
          arr: [
            ...
            "This should typically link to the first step of your service or a getting started page.",
          ],
        },
      },
      {
        name: "imageSrc",
        category: "Visual",
        value: "/assets/images/homepage-illustration.svg",
        description: {
          markdown: true,
          arr: [
            "The source URL for the illustration image.",
            "Use an illustration that helps users understand your service. The image should be decorative and not essential for understanding the content.",
          ],
        },
      },
      {
        ...
        description: {
          ...
          arr: [
            ...
            "Since the masthead image is typically decorative, this can often be left empty. If the image conveys important information, provide descriptive alt text.",
          ],
        },
      },
      {
...
{#snippet Component()}
  <div class="p-8">
    <Masthead {...parametersObject}></Masthead>
  </div>
{/snippet}

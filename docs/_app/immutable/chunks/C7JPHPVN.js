import"./CWj6FrbW.js";import{p as U,f as A,s as l,a as J,c as i,r as d,I as c,W as H,G as e,t as Y,M as X,B as F,D as j,a9 as R,F as V,u as Z}from"./Cp2qfsB-.js";import{t as f,c as ee,a as g}from"./R2PrfaHS.js";import{s as te}from"./ClzGr448.js";import{B as ae,d as re}from"./BaIcpsm5.js";import{W as ne,P as oe,C as se,B as ie,a as de,t as ue,c as le}from"./BBQ75O8h.js";import{p as pe}from"./C4bxO8ZZ.js";import{k as me}from"./lMwbQCpd.js";import{D as O}from"./BcmruyZp.js";import"./69_IOA4Y.js";import{s as G,e as ce}from"./Df23Nigv.js";import{e as ge,i as ve}from"./FoQIP_hg.js";import{s as he}from"./B2Z6IM-T.js";import{i as ye}from"./CFu0OaE2.js";import{A as fe,a as be}from"./B7r1Y1cT.js";import{C as M}from"./BywTUfDC.js";const xe=`
<script>
...
}`},description:{markdown:!0,arr:["A client-side validation function <code>(values: { day?, month?, year? }) => string | undefined</code>.","Receives an object with the current day, month, and year values and should return an error message string if invalid, or <code>undefined</code> if valid.","This validation runs in the browser and overrides the <code>errorMessage</code> if it returns an error string."]}}])),T=function(t,y,E){return t.map(u=>{let $=E[u.name]??u.value;return u.isEditable===y&&$!=null?typeof $=="object"?JSON.stringify($,null,2):$:null})},D=j(R(T(e(v),!0,{}))),S=V(()=>({})),x=V(()=>T(e(v),!1,e(S))),C=V(()=>ue(e(v),e(D))),P=V(()=>le(e(v),e(D),e(x))),w=V(()=>e(P)[0]),p=V(()=>e(P)[1]),k=R({});Z(()=>{e(p).forEach(t=>{k[t]=!0}),Object.keys(k).forEach(t=>{e(p).includes(t)||(k[t]=!1)})});let m=V(()=>Object.fromEntries(Object.entries(e(w)).map(([t,y])=>{var E,u;return[t,typeof y=="function"?(u=(E=e(v).find($=>$.name===t))==null?void 0:E.functionElements)==null?void 0:u.functionAsString:y]})));var I=ze(),h=A(I);ne(h,{wrapper:{component:{WrapperInformation:L,WrapperNameAndStatus:K},name:n},homepage:!1});var N=l(h,2);oe(N,{get parametersParsingErrorsArray(){return e(p)},get parametersParsingErrorsObject(){return k},onCloseFunction:t=>e(p).filter(y=>y!=t)});var q=l(N,2);se(q,{Component:a,get parametersSourceArray(){return e(v)},get derivedParametersValuesArray(){return e(x)},get parametersVisibleArray(){return e(C)},get parametersParsingErrorsObject(){return k},get copyParametersToClipboardObject(){return e(m)},get demoScreenWidth(){return e(_)},set demoScreenWidth(t){c(_,t,!0)},get statedParametersValuesArray(){return e(D)},set statedParametersValuesArray(t){c(D,t,!0)}});var z=l(q,2),Q=i(z);Fe(Q,{}),d(z),g(o,I),J()}const dt=Object.freeze(Object.defineProperty({__proto__:null,WrapperInformation:L,WrapperNameAndStatus:K,default:Ye},Symbol.toStringTag,{value:"Module"}));export{dt as _};

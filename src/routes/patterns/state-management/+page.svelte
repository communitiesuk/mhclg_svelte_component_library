...
<script>
  ...
  //   import StateManagement from "$lib/components/content/StateManagement.svelte";
  import Examples from "./state-management/Examples.svelte";
...
{#snippet Component()}
  <div class="p-8">
    <p>+page.svelte content</p>
    <!-- <StateManagement {...parametersObject}></StateManagement> -->
  </div>
{/snippet}

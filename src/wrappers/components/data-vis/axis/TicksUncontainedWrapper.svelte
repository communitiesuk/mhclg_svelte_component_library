...
<script>
  ...
  import TicksUncontained from "$lib/components/data-vis/axis/TicksUncontained.svelte";
  ...
  let parametersSourceArray = $derived(
    addIndexAndInitalValue([
      ...
      {
        name: "ticksArray",
        category: "specialTicksArrayCategory",
      },
    ]),
  );
    ...
    <svg width={demoScreenWidth} height={getValue("svgHeight")}>
      ...
      >
        {#key parametersObject}
          <TicksUncontained {...parametersObject} bind:ticksArray
          ></TicksUncontained>
        {/key}
      </g>
    </svg>

import"./CWj6FrbW.js";import{p as K,f as R,s as A,a as L,c as N,r as w,I as C,y as e,t as z,J as h,D as B,ab as F,u as oe,G as v,ac as re}from"./I52qY7cu.js";import{f as H,c as ne,a as g}from"./BBh-6AA0.js";import{i as X}from"./HAye_oo1.js";import{s as ie}from"./BHp14Q1u.js";import{B as se,d as ce}from"./DImQRQIn.js";import{W as le,P as de,C as pe,B as fe,a as ve,t as ue,c as me}from"./pjHBbLSa.js";import{p as he}from"./D7CmsDtu.js";import{k as ge}from"./lMwbQCpd.js";import{M as Y}from"./Wm1yA-Oo.js";import{d as be,s as G}from"./5F35P8og.js";import{s as ye}from"./BvNl7SXi.js";import{e as Se,i as xe}from"./n63ZiD1W.js";import{A as Ne,a as we}from"./DFHrQqYn.js";import"./69_IOA4Y.js";import{C as Ae}from"./BN7FUiX4.js";const He=`
<script lang="ts">
...
`;function _e(b,f){h(f,!e(f))}var ke=H('<p class="text-center text-gray-500 italic p-4">MobileNav is closed. Click the button above to open.</p>'),Oe=H(`<div class="p-5 bg-white border border-neutral-300 relative"><p class="govuk-body mb-4">This example shows how to control the <code>MobileNav</code> component's visibility
    ...
    controlled by a component like <code>HeaderNav</code>.</p> <div class="border border-neutral-300 min-h-[400px] bg-gray-50 demo-mobile-nav-container svelte-lf2kjm"><!></div>`,1),We=H('<!> <!> <!> <div id="examples" data-role="examples-section"><!></div>',1);function Fe(b,f){K(f,!0);const D=t=>{var a=Ve(),i=A(R(a),2),s=N(i);{var p=x=>{Y(x,ie(()=>e(O),{get activeSectionHref(){return e(_)},set activeSectionHref($){h(_,$,!0)},get activeDetailHref(){return e(T)},set activeDetailHref($){h(T,$,!0)}}))},P=x=>{var $=Be();g(x,$)};X(s,x=>{e(O).isOpen?x(p):x(P,!1)})}w(i),g(t,a)};let u=he.url.pathname.split("/"),E=ge(u[u.length-1]),M=C(F(ce.sm)),_=C("#components"),T=C("/components/layout/service-navigation-nested-mobile/mobile-nav"),j=F({counter:0,dataset:{lastHref:null},functionAsString:`function (href, event) {
  window.alert(

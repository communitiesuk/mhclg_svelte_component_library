...
import OneLoginHeader from "$lib/components/layout/OneLoginHeader.svelte";
    ...
    addIndexAndInitalValue([
      {
        ...
        description: {
          markdown: true,
          arr: [
            `This prop passes a URL text string to the <code>${pageName}</code> component.`,
          ],
        },
        rows: 1,
      },
...
{#snippet Component()}
  <div class="p-8">
<OneLoginHeader {...parametersObject}></OneLoginHeader>
  </div>
{/snippet}

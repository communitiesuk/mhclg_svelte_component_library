...
(function (Modules) {
  class GemSearchWithAutocomplete {
    constructor($module) {
      ...
      this.$inputWrapper = this.$module.querySelector(
    ...
    init() {
      const configOptions = {
        ...
        tStatusQueryTooShort: (minQueryLength) =>
          `Type in ${minQueryLength} or more characters for search suggestions`,
      ...
      this.$autocompleteInput.addEventListener("keydown", (e) => {
        const dropdownVisible =
          this.$autocompleteInput.getAttribute("aria-expanded") === "true";
    ...
    constructSuggestionHTMLString(result) {
      ...
      const inputValue = this.$inputWrapper
        .querySelector("input")
        .value.toLowerCase();
    ...
    setTrackingAttributes(query, results) {
      ...
      if (results.length > 0) {
        ...
        this.$autocompleteInput.dataset.autocompleteSuggestions =
          formattedResults;
        this.$autocompleteInput.dataset.autocompleteTriggerInput = query;
      }

      this.$autocompleteInput.dataset.autocompleteSuggestionsCount =
        results.length;
